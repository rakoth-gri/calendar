...
#### Наследование: стили, переданные Селектору ['$calendar'] унаследуется всеми компонентами, в т.ч. инпутами и компонентами поля отображения месячных дат. Это достигается за счет кода в предустановленных стилях ( файлы index.min.css / index.css):
